...
<%def name="sidebar()">
    <div class="well">
        <!--<h3>Sidebar</h3>-->
        <p>
            ATLAs is a living and regularly updated database. To submit corrections or queries about the data present in ATLAs, please click on the bell icons that appear on features, which open an email. You may also find information about how to reach us on the <a href="${request.route_url('contact')}">contact page</a>.
        </p>
    </div>
</%def>
...
<p class="lead">
    The Areal Typology of Languages of the Americas (ATLAs) is a database of typological features targeting areal linguistic structures in North and South America, gathered from language descriptions by a team of <a href="${request.route_url('contributors')}">21 authors</a>.
</p>
<p>
...
<p>
    The language sample of ATLAs includes 325 languages, of which 115 are in North America and 105 in South America. Their geographic distribution and phylogenetic relations can be seen in the map below.
</p>
...
<p>
    Data in ATLAs is organized into feature sets, which cover a typological domain or theme, and each feature set includes multiple features. Feature set descriptions provide lists of associated features, their linguistic motivation, coding methodology, and results, and can be accessed through the item "Feature Sets" in the navigation bar. Alternatively, features can be accessed directly, without going through feature sets description, in the "Features" tab of the same navigation bar. 
</p>
<p>
    You can also browse and search for languages through the item "Languages" on the navigation bar. Here, features can be viewed collectively for individual languages.
</p>
<p>
    The contributors to the database are given in the "Contributors" item, which associates individual authors and contributors with particular feature sets.
</p>
<p>
    You can search for references through the "References" item. Once you have navigated to a particular reference, you see a second navigation bar with textual citation and BibTeX citation options.
</p>
